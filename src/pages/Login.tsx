...
function Login() {
  ...
  return (
    <>
      ...
      {/* <div><img src="../assests/Desktop-13.png" alt="background-image" /></div> */}
    ...
    <div className="paraco">
      <p className="para">
      Revolutionize remote communication with our cutting-edge video web conferencing platform for seamless collaboration.
      </p>
    </div>
